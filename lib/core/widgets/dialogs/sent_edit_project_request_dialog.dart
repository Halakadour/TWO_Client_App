...
Future<dynamic> sentEditProjectRequestDialog(
  ...
  return showDialog(
    ...
    builder: (context) => SizedBox(
      height: 100,
      child: AlertDialog(
        title: Text("Sent An Edit Request", style: AppTextStyle.bodyLg()),
        content: SizedBox(
        ...
        actions: [
          ...
          BlocListener<AppBloc, AppState>(
            listenWhen: (previous, current) =>
                previous.sentEditProjectRequestStatus !=
                current.sentEditProjectRequestStatus,
            listener: (context, state) {
              AppBlocStateHandling().sentEditProjectRequest(state, context);
            },
